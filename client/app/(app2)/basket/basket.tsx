                                            ...
                                            <div className="flex flex-col items-start m-4 realtive top-10 gap-10 ">
                                                <div className="flex flex-wrap gap-10 lg:gap-24 b">
                                                    <button
                                                        ...
                                                        type="button" className=" w-[20px] h-[20px] text-gray-900 hover:text-white border border-gray-800 hover:bg-violet-900 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium 
                                                    rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2  dark:border-violet-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-violet-600 dark:focus:ring-violet-800">
                                                        <h1 className="relative bottom-2 right-1.5"> X</h1>
                                                    </button>
                                                    <h1 className="font-sans text-2xl  relative top-[10px]">Order Details</h1>
                                                </div>
                                                ...
                                                <div className='relative left-16'>
                                                    ...
                                                    <button
                                                        ...
                                                        <div className="text-white text-[17px] font-medium font-['Poppins']">CheckOut</div>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
